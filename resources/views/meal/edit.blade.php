                ...
                <form method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="range" min="0" max="10" step="1" value="{{$meals->morning_main}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="range" min="0" max="10" step="1" value="{{$meals->lunch_main}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="range" min="0" max="10" step="1" value="{{$meals->lunch_side}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="range" min="0" max="10" step="1" value="{{$meals->dinner_main}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="range" min="0" max="10" step="1" value="{{$meals->dinner_side}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="date" value="{{$meals->date}}">
                        </div>
